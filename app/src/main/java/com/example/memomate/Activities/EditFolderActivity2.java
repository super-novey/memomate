...
public class EditFolderActivity2 extends AppCompatActivity {
    TextView btnSave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_folder2);
        getFormWidgets();
        addEvents();
        getIntentFromEmptyFolderActivity();
        setFolder();
    }
    ...
    public void getFormWidgets()
    {
        ...
        progressDialog = new ProgressDialog(EditFolderActivity2.this);
        ...
        if (id_folder != null)
        {
            databaseReference.child(firebaseUser.getUid()).child("list_folder").child(id_folder).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    else Toast.makeText(EditFolderActivity2.this, "Error to load title", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(EditFolderActivity2.this, "Error to load title", Toast.LENGTH_SHORT).show();
                }
            });
        }
