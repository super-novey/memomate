...
public class EditStudySetActivity extends AppCompatActivity {
    ...
    public void getFormWidgets()
    {
        ...
        getIntentFromStudySetDetailActivity();

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, RecyclerView.VERTICAL, false);
        rcvCard.setLayoutManager(linearLayoutManager);

        cardAdapter.setData(listCard);   //set data
    ...
    public void addEvents()
    {
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                A.setId(currStudySet.getId());
                studySetViewModel.update(A);
                flashCardViewModel = new FlashCardViewModel(uid,A.getId());
                flashCardViewModel.remove();
                flashCardViewModel.addFlashCardList(listCard);
                onBackPressed();
            }
        });
        ...
        btnSetting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(EditStudySetActivity.this, SettingActivity.class);
                startActivity(i);
            }
        });
        ...
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT|ItemTouchHelper.RIGHT) {
            ...
            public void onChildDraw (Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive){
                new RecyclerViewSwipeDecorator.Builder(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                        .addBackgroundColor(ContextCompat.getColor(EditStudySetActivity.this, R.color.my_background))
    ...
    private void getIntentFromStudySetDetailActivity()
    {
        Bundle b = getIntent().getExtras();
        StudySet S = (StudySet) b.getSerializable("oldStudySet");
        if (S != null){
            listCard = S.getFlashCardList();
            edtTitle.setText(S.getName().toString());
            edtDes.setText(S.getDesc().toString());
            currStudySet = S;
        }
    }
